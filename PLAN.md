...
| 3 | Теми | The 8 areas: вештачка интелигенција, лидерство, менаџмент, комуникациски вештини, продажба, личен и професионален развој, емоционална интелигенција, дигитална трансформација | Numbered editorial list, two columns, hairline rules — **not** an icon-card grid. Numerals are oversized navy ghost figures, and each row has a hover state (rule → navy, 2px shift). |
